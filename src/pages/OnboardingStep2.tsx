...
const OnboardingStep2 = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      const existingUser = JSON.parse(localStorage.getItem("fryve_user") || "{}");
      localStorage.setItem("fryve_user", JSON.stringify({
        ...existingUser,
        businessAction,
        businessName: businessAction === "create" ? businessName : undefined,
        businessCode: businessAction === "join" ? businessCode : undefined,
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gradient">Business Setup</h1>
          <p className="text-gray-600">Connect with your restaurant</p>
        </div>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-3">
                ...
                <RadioGroup value={businessAction} onValueChange={setBusinessAction}>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="create" id="create" />
                    <Label htmlFor="create">Create a new business</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="join" id="join" />
                    <Label htmlFor="join">Join an existing business</Label>
                  </div>
                </RadioGroup>
              </div>
